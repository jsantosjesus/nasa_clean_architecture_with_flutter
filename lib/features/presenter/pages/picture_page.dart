...
import 'package:nasa_clean_architecture_with_flutter/features/presenter/widgets/custom_video_player.dart';
import 'package:nasa_clean_architecture_with_flutter/features/presenter/widgets/description_bottom_sheet.dart';
import 'package:nasa_clean_architecture_with_flutter/features/presenter/widgets/image_network_with_loader.dart';
import 'package:nasa_clean_architecture_with_flutter/features/presenter/widgets/page_slider_up.dart';
...
class _PicturePageState extends ModularState<PicturePage, HomeStoreController> {
  @override
  void initState() {
    super.initState();
